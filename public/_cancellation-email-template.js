// =============================================================================
//  /public/_cancellation-email-template.js — shared server + editor module
// =============================================================================
//
//  Lives in public/ so it is BOTH the server renderer (imported by
//  api/cancel-product.js via the api/_lib/cancellation-email-template.js shim)
//  and the My Booking editor's popup preview (imported in the browser as an ES
//  module). One module, so the wording a client previews while writing their
//  cancellation message is the wording their customer receives. Keep it
//  dependency-free and runtime-neutral: no Node imports, no DOM access.
//
