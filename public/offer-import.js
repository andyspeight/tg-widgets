...
(function () {
  ...
  const COLUMNS = [
    ...
    // Type-specific structured fields (cruise, flight-only, rail, tour). Optional
    // so older templates still validate; Download emits them for round-trip.
    { header: 'Ship', key: 'shipName', kind: 'field', optional: true },
    { header: 'Cruise line', key: 'cruiseLine', kind: 'field', optional: true },
    { header: 'Cabin', key: 'cabinType', kind: 'field', optional: true },
    { header: 'Cabin class', key: 'cabinClass', kind: 'field', optional: true },
    { header: 'Rail class', key: 'railClass', kind: 'field', optional: true },
    { header: 'Destination', key: 'destination', kind: 'field', optional: true },
    { header: 'Departure port', key: 'departurePort', kind: 'field', optional: true },
    { header: 'Departure station', key: 'station', kind: 'field', optional: true },
    { header: 'Tour operator', key: 'operator', kind: 'field', optional: true },
    { header: 'Rail operator', key: 'railOperator', kind: 'field', optional: true },
    { header: 'Group size', key: 'groupSize', kind: 'field', optional: true },
