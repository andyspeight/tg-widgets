...
export function renderEmailHtml(order, opts = {}) {
  ...
  const orderRef = accomItem?.bookingReference || (order.id ? String(order.id) : '');
          ...
          <td style="padding:24px 32px 0;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr>
                ...
                <td style="padding:12px 0;border-bottom:1px solid #F1F5F9;text-align:right;font-size:14px;font-weight:600;color:${colors.text};font-family:${fontStack};">${escapeHtml([unit.roomType || unit.name, rate?.board].filter(Boolean).join(' · '))}</td>
              </tr>` : ''}
              ${nights ? `
              <tr>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:${radiusLg};">
              <tr>
                <td style="padding:16px 20px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td style="font-size:14px;color:#475569;padding:4px 0;font-family:${fontStack};">Total cost</td>
