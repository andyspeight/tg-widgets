...
export const COMPETITIONS = [
  ...
  { slug: 'english-premier-league', label: 'Premier League',        category: 'football', aliases: ['english premier league', 'premier league'] },
  { slug: 'english-championship',   label: 'Championship',          category: 'football', aliases: ['english football league championship', 'championship'] },
  { slug: 'spanish-la-liga',        label: 'La Liga',               category: 'football', aliases: ['spanish la liga', 'la liga'] },
  { slug: 'spanish-segunda',        label: 'Segunda División',      category: 'football', aliases: ['spanish league 2nd division', 'segunda división', 'segunda division'] },
  { slug: 'italian-serie-a',        label: 'Serie A',               category: 'football', aliases: ['italian serie a', 'serie a'] },
  { slug: 'brazilian-serie-a',      label: 'Brazilian Série A',     category: 'football', aliases: ['brazilian serie a', 'serie a (brazil)'] },
  { slug: 'german-bundesliga',      label: 'Bundesliga',            category: 'football', aliases: ['german bundesliga', 'bundesliga'] },
  { slug: 'german-2-bundesliga',    label: '2. Bundesliga',         category: 'football', aliases: ['german 2. bundesliga'] },
  { slug: 'austrian-bundesliga',    label: 'Austrian Bundesliga',   category: 'football', aliases: ['austrian bundesliga', 'bundesliga at'] },
  { slug: 'french-ligue-1',         label: 'Ligue 1',               category: 'football', aliases: ['french ligue 1', 'ligue 1'] },
  { slug: 'french-ligue-2',         label: 'Ligue 2',               category: 'football', aliases: ['french league 2'] },
  { slug: 'belgian-pro-league',     label: 'Belgian Pro League',    category: 'football', aliases: ['belgium league', 'pro league'] },
  { slug: 'dutch-eredivisie',       label: 'Eredivisie',            category: 'football', aliases: ['dutch eredivisie', 'eredivisie'] },
  { slug: 'portuguese-primeira',    label: 'Primeira Liga',         category: 'football', aliases: ['portuguese league', 'primeira liga'] },
  { slug: 'danish-superliga',       label: 'Superliga',             category: 'football', aliases: ['danish superliga', 'superligaen'] },
  { slug: 'scottish-premiership',   label: 'Scottish Premiership',  category: 'football', aliases: ['scottish premiership'] },
  ...
  { slug: 'czech-first-league',     label: 'Czech First League',    category: 'football', aliases: ['czech first league'] },
  { slug: 'croatian-hnl',           label: 'Croatian HNL',          category: 'football', aliases: ['first croatian football league'] },
  { slug: 'greek-super-league',     label: 'Super League Greece',   category: 'football', aliases: ['super league greece'] },
  { slug: 'swiss-super-league',     label: 'Swiss Super League',    category: 'football', aliases: ['swiss super league'] },
  { slug: 'turkish-super-lig',      label: 'Süper Lig',             category: 'football', aliases: ['turkish super lig'] },
  { slug: 'polish-ekstraklasa',     label: 'Ekstraklasa',           category: 'football', aliases: ['polish league (ekstraklasa)'] },
  { slug: 'serbian-superliga',      label: 'Serbian SuperLiga',     category: 'football', aliases: ['serbian league'] },
  { slug: 'swedish-allsvenskan',    label: 'Allsvenskan',           category: 'football', aliases: ['swedish league allsvenskan'] },
  { slug: 'argentine-primera',      label: 'Primera División',      category: 'football', aliases: ['argentine primera division'] },
  { slug: 'mls',                    label: 'MLS',                   category: 'football', aliases: ['mls (soccer)'] },
  ...
  { slug: 'copa-do-brasil',         label: 'Copa do Brasil',        category: 'football', aliases: ['copa do brasil'] },
  ...
  { slug: 'efl-cup',                label: 'EFL Cup',               category: 'football', aliases: ['efl (carabao) cup'] },
  { slug: 'dfb-pokal',              label: 'DFB-Pokal',             category: 'football', aliases: ['german cup (dfb-pokal)'] },
  { slug: 'taca-da-liga',           label: 'Taça da Liga',          category: 'football', aliases: ['portuguese league cup (taça da liga)'] },
  ...
  { slug: 'joan-gamper-cup',        label: 'Joan Gamper Trophy',    category: 'football', aliases: ['joan gamper cup'] },

  // ── American football ──────────────────────────────────────────────────────
  { slug: 'nfl',           label: 'NFL',           category: 'american-football', aliases: ['nfl (us football)', 'nfl international games'] },
  { slug: 'nfl-preseason', label: 'NFL Preseason', category: 'american-football', aliases: ['nfl preseason'] },
  { slug: 'super-bowl',    label: 'Super Bowl',    category: 'american-football', aliases: ['super bowl lxi 2027'] },

  // ── Baseball, basketball, ice hockey ───────────────────────────────────────
  { slug: 'mlb',                 label: 'MLB',                 category: 'baseball',   aliases: ['mlb (baseball)'] },
  { slug: 'nba',                 label: 'NBA',                 category: 'basketball', aliases: ['nba (basketball)', 'nba europe games', 'nba global games'] },
  { slug: 'nba-preseason',       label: 'NBA Preseason',       category: 'basketball', aliases: ['nba preseason'] },
  { slug: 'wnba',                label: 'WNBA',                category: 'basketball', aliases: ['wnba'] },
  ...
  { slug: 'nhl',                 label: 'NHL',                 category: 'ice-hockey', aliases: ['nhl (ice hockey)'] },
  { slug: 'nhl-preseason',       label: 'NHL Preseason',       category: 'ice-hockey', aliases: ['nhl preseason'] },
  { slug: 'nhl-special',         label: 'NHL Special Events',  category: 'ice-hockey', aliases: ['nhl all star game', 'nhl global series', 'nhl stadium series', 'nhl winter classic', 'stanley cup finals'] },
  { slug: 'champions-hockey-league', label: 'Champions Hockey League', category: 'ice-hockey', aliases: ['champions hockey league'] },

  // ── Tennis ─────────────────────────────────────────────────────────────────
  { slug: 'us-open-tennis',     label: 'US Open',            category: 'tennis', aliases: ['us open (tennis – grand slam)', 'us open (tennis - grand slam)', 'us open tennis'] },
  { slug: 'australian-open',    label: 'Australian Open',    category: 'tennis', aliases: ['australian open (grand slam)'] },
  { slug: 'wimbledon',          label: 'Wimbledon',          category: 'tennis', aliases: ['wimbledon (grand slam)'] },
  ...
  { slug: 'nitto-atp-finals',   label: 'Nitto ATP Finals',   category: 'tennis', aliases: ['nitto atp finals'] },
  ...
  { slug: 'beach-tennis-open',  label: 'Aruba Open Beach Tennis', category: 'tennis', aliases: ['aruba open beach tennis championship'] },
  ...
  { slug: 'cheltenham-festival',    label: 'Cheltenham Festival',    category: 'horse-racing', aliases: ['cheltenham festival'] },
  ...
  { slug: 'nascar',    label: 'NASCAR',    category: 'motorsport', aliases: ['nascar', 'nascar  cook out southern 500', 'coke zero sugar 400', 'cook out 400', 'iowa corn 350', 'xfinity 500', 'freeway insurance 500'] },
